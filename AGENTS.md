...
- **Fix gepushed, CI gruen.** Test-APK-URL: https://github.com/ReichiMD/ARVIO/actions/runs/32303336035 (Artifact "arvio-stalker-test", 101MB). Nutzer noch am Testen, ob Maske aufgeht.
- **Session-Wechsel:** Neue Session mit Repo ReichiMD/ARVIO + Branch feat/stalker-settings-ui. Dort die frische kleine AGENTS.md. Logging (StalkerUiDbg) vor PR zu entfernen + AGENTS.md aus Branch entfernen.